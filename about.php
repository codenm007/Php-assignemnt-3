				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 col-sm-6">
							<div class="team">
								<div class="card">
									<img src="images/user1.png" class="card-img-top team-img"  alt="">
									<div class="card-body">
										<h4 class="card-title teamTitle">ANUBHAV SINGH</h4>
										<div class="social">
						...
						<div class="col-md-3 col-sm-6">
							<div class="team">
								<div class="card">
									<img src="images/user2.png" class="card-img-top team-img"  alt="">
									<div class="card-body">
										<h4 class="card-title teamTitle">KENNY GONSALVES</h4>
										<div class="social">
											<a href="#" class="linkedin" data-toggle="tooltip" title="Linkedin"><i class="fab fa-linkedin"></i></a>
											<a href="#" class="facebook" data-toggle="tooltip" title="Facebook"><i class="fab fa-facebook-square"></i></a>
											<a href="#" class="github" data-toggle="tooltip" title="Github"><i class="fab fa-github"></i></a>
						...
						<div class="col-md-3 col-sm-6">
							<div class="team">
								<div class="card">
									<img src="images/user3.png" class="card-img-top team-img"  alt="">
									<div class="card-body">
										<h4 class="card-title teamTitle">AAVEZ AHMED</h4>
										<div class="social">
											<a href="#" class="linkedin" data-toggle="tooltip" title="Linkedin"><i class="fab fa-linkedin"></i></a>
											<a href="#" class="facebook" data-toggle="tooltip" title="Facebook"><i class="fab fa-facebook-square"></i></a>
											<a href="#" class="github" data-toggle="tooltip" title="Github"><i class="fab fa-github"></i></a>
						...
						<div class="col-md-3 col-sm-6">
							<div class="team">
								<div class="card">
									...
									<div class="card-body">
										<h4 class="card-title teamTitle">RYAN GONSALVES</h4>
										<div class="social">
											<a href="#" class="linkedin" data-toggle="tooltip" title="Linkedin"><i class="fab fa-linkedin"></i></a>
											<a href="#" class="facebook" data-toggle="tooltip" title="Facebook"><i class="fab fa-facebook-square"></i></a>
											<a href="#" class="github" data-toggle="tooltip" title="Github"><i class="fab fa-github"></i></a>
					...
					<div class="row about-C">
						<div class="col-md-12">
							<div class="aboutContent">
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat quam ipsam ut unde fuga ipsum. Voluptates placeat aliquam obcaecati at eum ad, aliquid, inventore sed ea consequatur dicta expedita, quas. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat doloremque in aut quo dicta veniam dolorem, recusandae quam laborum officia cum, sunt facilis consequatur officiis ratione vel eum ad unde. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat quam ipsam ut unde fuga ipsum. Voluptates placeat aliquam obcaecati at eum ad, aliquid, inventore sed ea consequatur dicta expedita, quas. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat doloremque in aut quo dicta veniam dolorem, recusandae quam laborum officia cum, sunt facilis consequatur officiis ratione vel eum ad unde.</p>
							</div>
						</div>
					</div>
